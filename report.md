...
The adoption of AI automation can also have an impact on the repository as a place of human-to-human collaboration. Crucially, the repositories in this analysis were generally "dormant" - that is, they had very low human-to-human interaction at point of adoption. This means **there was no significant human-to-human collaboration to impact**. This means the impact on human-to-human processes is neither explored nor measurable in this report. However the general feeling is that automated AI can be highly corrosive on social platforms and this should be taken into account before adopting any AI automation. Future research should explore the social impact of AI automation in open source communities.
